...
function getBaseSchedule() {
	...
	let ret = [`Vintage ${ch}`, `Limited ${ch} (32-player)`, null, null, `Modern ${ch}`, null, `Pioneer ${ch}`, null, `Legacy ${ch}`, null, `Pauper ${ch}`, null,
		...
		null, null, `Limited ${pr}`, null, `Modern ${pr}`, null, null, `Legacy ${pr}`, null, null, `Limited ${pr}`, `Vintage ${pr}`,
...
function getRCQs() {
	...
	ret.set(
		new Date(2023, 9, 16).toDateString(),
		{ 0 : "plus&Vintage Cube 64-player Single Elim&minus",
		1 : "plus&Vintage Cube 64-player Single Elim&minus",
		2 : "plus&Vintage Cube 64-player Single Elim&minus",
		3 : "plus&Vintage Cube 64-player Single Elim&minus",
	...
	ret.set(
		new Date(2023, 9, 17).toDateString(),
		{ 0 : "plus&Vintage Cube 64-player Single Elim&minus",
		1 : "plus&Vintage Cube 64-player Single Elim&minus",
		2 : "plus&Vintage Cube 64-player Single Elim&minus",
		3 : "plus&Vintage Cube 64-player Single Elim&minus",
	...
	ret.set(
		new Date(2023, 9, 18).toDateString(),
		{ 0 : "plus&Vintage Cube 64-player Single Elim&minus",
		1 : "plus&Vintage Cube 64-player Single Elim&minus",
		2 : "plus&Vintage Cube 64-player Single Elim&minus",
		3 : "plus&Vintage Cube 64-player Single Elim&minus",
