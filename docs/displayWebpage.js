      ...
      if (event) {
        if (event === "DST") {
          ...
          try {
            ...
            // No per-event calendar icon: batch export handled via checkboxes and toolbar
            var calendarAnchor = "";
            ...
            var eventString = `<font color= #COLOR>${checkboxHtml}${getPrettyTime(hour, minute)} #EVENT</font><br>`;
          } catch (e) {
